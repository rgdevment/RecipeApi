...
-- Recipes (spanish)
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Chupe de marisco al estilo puerto de Antofagasta', 'Preparación del chupe en Antofagasta...', 60, 4, 'Chile', 'BEGINNER', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Tacos de Pescado y Mariscos en un ambiente Queretano', 'Preparación de los tacos...', 30, 2, 'México', 'BASIC', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Ensalada de Lechuga y Tomate con Queso', 'Preparación de la ensalada...', 15, 2, 'Perú', 'BASIC', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Tortilla de Patatas sin patatas y sin tortilla', 'Preparación de la tortilla...', 30, 4, 'España', 'INTERMEDIATE', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Recipes (English)
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Fish and Chips', 'Preparation of Fish and Chips...', 45, 2, 'England', 'INTERMEDIATE', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Cheeseburger Vegan with chips', 'Preparation of Cheeseburger...', 30, 1, 'USA', 'BASIC', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Beef Tartare', 'Preparation of Beef Tartare...', 30, 2, 'Italia', 'INTERMEDIATE', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO recipes (id, title, preparation, cooking_time, serving_size, origin_version, difficulty, user_id, created_at, updated_at) VALUES(nextval('recipes_seq'), 'Sausage with bread', 'Preparation of Bratwurst mit Brot...', 15, 1, 'Deutschland', 'BASIC', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
